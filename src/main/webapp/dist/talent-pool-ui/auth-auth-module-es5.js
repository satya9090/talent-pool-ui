(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-auth-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeerLoginComponent = /** @class */ (function () {
                function EmployeerLoginComponent(formBuilder, router, store) {
                ...
                EmployeerLoginComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.store.select('authState').subscribe(function (authState) {
                        _this.error = authState.errorMessage;
                        _this.loading = authState.loading;
                        if (authState.user) {
                            _this.router.navigate(['/onboarding/personal-info']);
                        }
                    });
                };
                Object.defineProperty(EmployeerLoginComponent.prototype, "f", {
                    get: function () {
                ...
                EmployeerLoginComponent.prototype.login = function () {
                    this.submitted = true;
                ...
                return EmployeerLoginComponent;
            }());
            EmployeerLoginComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeerRegistartionComponent = /** @class */ (function () {
                function EmployeerRegistartionComponent(formBuilder) {
                    this.formBuilder = formBuilder;
                    this.submitted = false;
                }
                EmployeerRegistartionComponent.prototype.ngOnInit = function () {
                ...
                Object.defineProperty(EmployeerRegistartionComponent.prototype, "f", {
                ...
                EmployeerRegistartionComponent.prototype.register = function () {
                    this.submitted = true;
                ...
                return EmployeerRegistartionComponent;
            }());
            EmployeerRegistartionComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JobSeekerLoginComponent = /** @class */ (function () {
                function JobSeekerLoginComponent(formBuilder, router, store) {
                    this.formBuilder = formBuilder;
                    this.router = router;
                    this.store = store;
                    this.submitted = false;
                ...
                JobSeekerLoginComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loginForm = this.formBuilder.group({
                ...
                Object.defineProperty(JobSeekerLoginComponent.prototype, "f", {
                    get: function () {
                        return this.loginForm.controls;
                    },
                    enumerable: true,
                ...
                JobSeekerLoginComponent.prototype.login = function () {
                    this.submitted = true;
                    if (this.loginForm.invalid) {
                        return;
                    }
            ...
            JobSeekerLoginComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JobSeekerRegistrationComponent = /** @class */ (function () {
                function JobSeekerRegistrationComponent(formBuilder, store, router) {
                    this.formBuilder = formBuilder;
                    this.store = store;
                    this.router = router;
                    this.submitted = false;
                ...
                Object.defineProperty(JobSeekerRegistrationComponent.prototype, "f", {
                    // convenience getter for easy access to form fields
                    get: function () {
                        return this.registerForm.controls;
                    },
                ...
                JobSeekerRegistrationComponent.prototype.register = function () {
                    this.submitted = true;
                    // stop here if form is invalid
                    if (this.registerForm.invalid) {
                        return;
            ...
            JobSeekerRegistrationComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_4__["Store"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ResetPasswordComponent = /** @class */ (function () {
                function ResetPasswordComponent(formBuilder) {
                    this.formBuilder = formBuilder;
                    this.submitted = false;
                }
