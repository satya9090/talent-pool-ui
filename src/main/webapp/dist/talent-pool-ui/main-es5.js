(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                {
                    path: 'auth',
                    loadChildren: function () { return Promise.all(/*! import() | auth-auth-module */ [__webpack_require__.e("default~auth-auth-module~onboarding-onboarding-module~recruiter-recruiter-module"), __webpack_require__.e("auth-auth-module")]).then(__webpack_require__.bind(null, /*! ./auth/auth.module */ "./src/app/auth/auth.module.ts")).then(function (mod) { return mod.AuthModule; }); }
                },
                {
                    path: 'onboarding',
                    loadChildren: function () { return Promise.all(/*! import() | onboarding-onboarding-module */ [__webpack_require__.e("default~auth-auth-module~onboarding-onboarding-module~recruiter-recruiter-module"), __webpack_require__.e("onboarding-onboarding-module")]).then(__webpack_require__.bind(null, /*! ./onboarding/onboarding.module */ "./src/app/onboarding/onboarding.module.ts")).then(function (mod) { return mod.OnboardingModule; }); }
                },
                {
                    path: 'job-seeker',
                    loadChildren: function () { return __webpack_require__.e(/*! import() | job-seeker-job-seeker-module */ "job-seeker-job-seeker-module").then(__webpack_require__.bind(null, /*! ./job-seeker/job-seeker.module */ "./src/app/job-seeker/job-seeker.module.ts")).then(function (mod) { return mod.JobSeekerModule; }); }
                },
                {
                    path: 'recruiter',
                    loadChildren: function () { return Promise.all(/*! import() | recruiter-recruiter-module */ [__webpack_require__.e("default~auth-auth-module~onboarding-onboarding-module~recruiter-recruiter-module"), __webpack_require__.e("recruiter-recruiter-module")]).then(__webpack_require__.bind(null, /*! ./recruiter/recruiter.module */ "./src/app/recruiter/recruiter.module.ts")).then(function (mod) { return mod.RecruiterModule; }); }
                }
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthSuccess = /** @class */ (function () {
            ...
            var AuthRegistrationStart = /** @class */ (function () {
                function AuthRegistrationStart(payload) {
                    this.payload = payload;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var TOGGLE_PROFILE_SELECTION = 'TOGGLE_PROFILE_SELECTION';
            var ToggleProfileSelection = /** @class */ (function () {
                function ToggleProfileSelection(payload) {
                    this.payload = payload;
                    this.type = TOGGLE_PROFILE_SELECTION;
                }
                return ToggleProfileSelection;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function JobSeekerReducer(state, action) {
                if (state === void 0) { state = initialState; }
                switch (action.type) {
                    default:
                        return state;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function RecruiterReducer(state, action) {
                if (state === void 0) { state = initialState; }
                switch (action.type) {
                    case _actions_recruiter_actions__WEBPACK_IMPORTED_MODULE_1__["TOGGLE_PROFILE_SELECTION"]:
                        return Object.assign({}, state, { profiles: state.profiles.map(function (prof) {
